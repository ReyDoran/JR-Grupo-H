...
public class WebsocketEchoHandler extends TextWebSocketHandler {
	...
	BlockingQueue <WebSocketSession>matchmaking = new ArrayBlockingQueue<>(1000); //Los jugadores que estan buscando se emparejan por orden de llegada
		...
		switch(code)
		{
		    ...
		    case "0":
		    {
		    	...
		    	if(matchmaking.size() > 1)
		    	{
		    		...
		    		responseNode1.put("session",a.getId());//Se le envia la id del otro para saber donde enviar informacion
		    		...
		    		responseNode2.put("session",b.getId());//Se le envia la id del otro para saber donde enviar informacion
