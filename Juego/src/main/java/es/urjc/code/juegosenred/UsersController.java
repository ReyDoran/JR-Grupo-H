...
=======
	...
	/**
	 * Devuelve una lista de los nombres de usuarios conectados Para comprobar si un
	 * usuario está conectado, se comprueba cuántos segundos han pasado desde su
	 * última petición GET.
	 * 
>>>>>>> developing
	 * @return
...
=======
	...
	/**
	 * Añade un nuevo usuario al mapa siempre y cuando no exista uno ya con ese
	 * nombre. Devuelve CREATED si se ha creado, error si no.
	 * 
>>>>>>> developing
	 * @param user
	 * @return
...
=======
	 * Comprueba si el par usuario contraseña existen en el servidor. Devuelve OK y
	 * el id del usuario si es correcto. Devuelve NOT_FOUND si no es correcto.
	 * 
>>>>>>> developing
	 * @param id
...
=======
	 ...
	 * User savedUser = users.get(id);
	 * 
	 * if (savedUser != null) { users.remove(savedUser.getId()); return new
	 * ResponseEntity<>(savedUser, HttpStatus.OK); } else { return new
